...
import { BarChart3, Download, Users, Globe, Star, X } from "lucide-react"
...
export default function AnalyticsDashboard() {
  ...
  if (!isVisible) {
    return (
      <Button variant="outline" onClick={() => setIsVisible(true)} className="fixed bottom-4 right-4 z-50 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Feedback QRs</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Website QRs</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">With Logo</div>
              </CardContent>
            </Card>
          </div>
                    ...
                    <Card key={index} className="p-3">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {item.hasLogo && <Badge variant="secondary">Logo</Badge>}
                        </div>
                      </div>
                    </Card>
                  ))}
